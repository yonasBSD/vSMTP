...
vSMTP enable you to create complex set of rules to filter your emails using [vSMTP's scripting language (vsl)](https://vsmtp.rs/ref/vSL/api.html) based on [Rhai](https://github.com/rhaiscript/rhai).
You can:
